...
namespace MBProtoLib.Core
{
    public class CustomerAuth
    {
        ...
        public CustomerAuth(Dictionary<uint, Type> constructors, string connectionString, string mbProtoConnectionString)
        {
        ...
        public static byte[] MakeResponse(string coreUrl, long customerId, long sessionID, string diffKey, string result)
        {
            ...
            using (var writer = new BinaryWriter(ms))
            {
                ...
                return CustomerAuth.GenerateMessage(new AES(runtimeAESKey).Encrypt(ms.ToArray()));
            }
        }
    }
}
